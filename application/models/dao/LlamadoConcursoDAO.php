...
{
    public const TB_NOMBRE = 'public.llamado_concurso';
    public const VW_NOMBRE = 'public.llamado_concurso_view';
    ...
    public function calcularLapsos($fechaLlamado, int $diasHabiles, array $feriados)
    {
        ...
        for ($dh = 1; $dh <= $diasHabiles;) {
            if (!$this->esFinDeSemana($fechaAux) && !$this->esFeriado($fechaAux, $feriados)) {
                ...
                if ($dh === 2 && $fechaInicioAclaratoria === null) { // esto agregue
                    $fechaInicioAclaratoria = $fechaAux;
                }

                if ($dh === 4 && $fechaFinAclaratoria === null) {
        ...
        $fechasLapsos = array(
            ...
            'fecha_inicio_aclaratoria' => $fechaInicioAclaratoria,
