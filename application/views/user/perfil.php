                                        ...
                                        <tbody>
                                            <?php foreach ($ver_perfil as $data) : ?>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td>
                                                        <a class="button" href="<?php echo base_url() ?>index.php/User/verPerfil?id=<?php echo $data['id_perfil']; ?>">
                                                            <i title="Ver Pago" class="fas fa-lg fa-fw fa-eye" style="color: midnightblue;"></i>
                                                        <a />
                                                
                                                        <a onclick="perfiles(<?php echo $data['id_perfil'] ?>);" data-toggle="modal"
                                        data-target="#perfilm" style="color: white">
...
<div class="modal fade" id="perfilm" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-2">
                            ...
                            <select class=" form-control " id="menu_progr2" name="menu_progr2" >
                                     <option value="2">Sel</option><option value="0">No</option>
                                    <option value="1">Si</option>
                                </select>
                        </div>
                        <div class="form-group col-2">
                            <label>Visualizar Menú Evaluación de Desempeño <b title="Campo Obligatorio" style="color:red">*</b></label>
                            <input type="text" name="menu_eval_desem1" id="menu_eval_desem1"  class="form-control" readonly >
                            <input type="text" name="menu_eval_desem3" id="menu_eval_desem3"  class="form-control" readonly >
                           
                        </div>
                        <div class="form-group col-2">
                            <label>Camb.Visualizar Menú Evaluación de Desempeño <b title="Campo Obligatorio" style="color:red">*</b></label>
                        ...
                        <div class="form-group col-2">
                            <label>Registrar Evaluación de Desempeño <b title="Campo Obligatorio" style="color:red">*</b></label>
                            <input type="text" name="menu_reg_eval_desem1" id="menu_reg_eval_desem1"  class="form-control" readonly >
                            <input type="text" name="menu_reg_eval_desem3" id="menu_reg_eval_desem3"  class="form-control" readonly >
                           
                        </div>
                        <div class="form-group col-2">
                            <label>Camb.Registrar Evaluación de Desempeño <b title="Campo Obligatorio" style="color:red">*</b></label>
                        ...
                        <div class="form-group col-2">
                            <label>Visualizar Menú Anulación Eval. de Desempeño <b title="Campo Obligatorio" style="color:red">*</b></label>
                            <input type="text" name="menu_anulacion1" id="menu_anulacion1"  class="form-control" readonly >
                            <input type="text" name="menu_anulacion3" id="menu_anulacion3"  class="form-control" readonly >
                           
                        </div>
                        <div class="form-group col-2">
                            <label>Camb.Visualizar Menú Anulación Eval. de Desempeño <b title="Campo Obligatorio" style="color:red">*</b></label>
                        ...
                        <div class="form-group col-2">
                            <label>Solicitar Anulación Eval. de Desempeño <b title="Campo Obligatorio" style="color:red">*</b></label>
                            <input type="text" name="menu_soli_anular_eval_desem1" id="menu_soli_anular_eval_desem1"  class="form-control" readonly >
                            <input type="text" name="menu_soli_anular_eval_desem3" id="menu_soli_anular_eval_desem3"  class="form-control" readonly >
                           
                        </div>
                        <div class="form-group col-2">
                            <label>Camb. Solicitar Anulación Eval. de Desempeño <b title="Campo Obligatorio" style="color:red">*</b></label>
                            <select class=" form-control " id="menu_soli_anular_eval_desem2" name="menu_soli_anular_eval_desem2" >
                                     <option value="2">Sel</option><option value="0">No</option>
                                    <option value="1">Si</option>
                                </select>
                        </div>
                        <div class="form-group col-2">
                            <label>Procesar Anulación Eval. de Desempeño <b title="Campo Obligatorio" style="color:red">*</b></label>
                            <input type="text" name="menu_proc_anular_eval_desem1" id="menu_proc_anular_eval_desem1"  class="form-control" readonly >
                            <input type="text" name="menu_proc_anular_eval_desem3" id="menu_proc_anular_eval_desem3"  class="form-control" readonly >
                           
                        </div>
                        <div class="form-group col-2">
                            <label>Camb.Procesar Anulación Eval. de Desempeño <b title="Campo Obligatorio" style="color:red">*</b></label>
                            <select class=" form-control " id="menu_proc_anular_eval_desem2" name="menu_proc_anular_eval_desem2" >
                                     <option value="2">Sel</option><option value="0">No</option>
                                    <option value="1">Si</option>
                                </select>
                        </div>
                        ...
                        <div class="form-group col-2">
                            <label>Comprobante Eval. de Desempeño <b title="Campo Obligatorio" style="color:red">*</b></label>
                            <input type="text" name="menu_comprobante_eval_desem1" id="menu_comprobante_eval_desem1"  class="form-control" readonly >
                            <input type="text" name="menu_comprobante_eval_desem3" id="menu_comprobante_eval_desem3"  class="form-control" readonly >
                           
                        </div>
                        <div class="form-group col-2">
                            <label>Comprobante Eval. de Desempeño <b title="Campo Obligatorio" style="color:red">*</b></label>
                            <select class=" form-control " id="menu_comprobante_eval_desem2" name="menu_comprobante_eval_desem2" >
                                     <option value="2">Sel</option><option value="0">No</option>
                                    <option value="1">Si</option>
                                </select>
                        </div>
                        <div class="form-group col-2">
                            <label>Estadistica Evalua. de Desempeño <b title="Campo Obligatorio" style="color:red">*</b></label>
                            <input type="text" name="menu_estdi_eval_desem1" id="menu_estdi_eval_desem1"  class="form-control" readonly >
                            <input type="text" name="menu_estdi_eval_desem3" id="menu_estdi_eval_desem3"  class="form-control" readonly >
                           
                        </div>
                        <div class="form-group col-2">
                            <label>Camb.Estadistica Evalua. de Desempeño <b title="Campo Obligatorio" style="color:red">*</b></label>
                        ...
                        <div class="form-group col-2">
                            <label>Empresa no Reg. Eval. de Desempeño <b title="Campo Obligatorio" style="color:red">*</b></label>
                            <input type="text" name="menu_noregi_eval_desem1" id="menu_noregi_eval_desem1"  class="form-control" readonly >
                            <input type="text" name="menu_noregi_eval_desem3" id="menu_noregi_eval_desem3"  class="form-control" readonly >
                           
                        </div>
                        <div class="form-group col-2">
                            <label>Camb.Empresa no Reg. Eval. de Desempeño <b title="Campo Obligatorio" style="color:red">*</b></label>
                        ...
                        <div class="form-group col-2">
                            <label>Camb.Visualizar Menu Llamado a concurso <b title="Campo Obligatorio" style="color:red">*</b></label>
                        ...
                        <div class="form-group col-2">
                            <label>Consultar Llamado a concurso <b title="Campo Obligatorio" style="color:red">*</b></label>
                            <input type="text" name="consultar_llamado1" id="consultar_llamado1"  class="form-control" readonly >
                            <input type="text" name="consultar_llamado3" id="consultar_llamado3"  class="form-control" readonly >
                           
                        </div>
                        <div class="form-group col-2">
                            <label>Camb.Consultar Llamado a concurso <b title="Campo Obligatorio" style="color:red">*</b></label>
                        ...
                        <div class="form-group col-2">
                            <label>Camb.Registrar Llamado a concurso <b title="Campo Obligatorio" style="color:red">*</b></label>
                        ...
                        <div class="form-group col-2">
                            <label>Camb.Anulaciones Llamado a concurso <b title="Campo Obligatorio" style="color:red">*</b></label>
                        ...
                        <div class="form-group col-2">
                            <label>Ver Anulaciones de Llamado a concurso  <b title="Campo Obligatorio" style="color:red">*</b></label>
                            <input type="text" name="ver_anul_llamado1" id="ver_anul_llamado1"  class="form-control" readonly >
                            <input type="text" name="ver_anul_llamado3" id="ver_anul_llamado3"  class="form-control" readonly >
                        ...
                        <div class="form-group col-2">
                            <label>Camb.Visualizar Configuración <b title="Campo Obligatorio" style="color:red">*</b></label>
                        ...
                        <div class="form-group col-2">
                            <label>Camb.Visualizar Conf. Publicaciones <b title="Campo Obligatorio" style="color:red">*</b></label>
                        ...
                        <div class="form-group col-2">
                            ...
                            <input type="text" name="ver_user_exter1" id="ver_user_exter1"  class="form-control" readonly >
                            <input type="text" name="ver_user_exter3" id="ver_user_exter3"  class="form-control" readonly >
                        ...
                        <div class="form-group col-2">
                            <label>Lista Usuarios<b title="Campo Obligatorio" style="color:red">*</b></label>
                            <input type="text" name="ver_user_lista1" id="ver_user_lista1"  class="form-control" readonly >
                            <input type="text" name="ver_user_lista3" id="ver_user_lista3"  class="form-control" readonly >
                        ...
                        <div class="form-group col-2">
                            ...
                            <input type="text" name="ver_user_perfil1" id="ver_user_perfil1"  class="form-control" readonly >
                            <input type="text" name="ver_user_perfil3" id="ver_user_perfil3"  class="form-control" readonly >
            ...
            <div class="modal-footer">
                <button type="button" onclick="javascript:window.location.reload()" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="button" id="guardar_adelanto_pag_b" onclick="edit_perfil();" class="btn btn-primary">Guardar</button>
            </div>
        </div>
    </div>
</div>
