...
<div id="content" class="content">
    <h2>Continuar la carga de la programación Bienes-acc</h2>
    <div class="row">
            ...
            <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                ...
                <form class="form-horizontal" id="guardar_tcu" data-parsley-validate="true" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="card card-outline-danger">
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="form-group col-2">
                                        <label>Cantd. a Distribuir <b style="color:red">*</b><i style="color: red;"
                    ...
                    <div class="form-group col 12 text-center">
                        <button type="button" onclick="guardar_acc_bien();" id="guardar" name="guardar"
            ...
            <div class="panel panel-inverse">
                ...
                <div class="form-group col 12 text-center">
                    <button type="button" class="my-button3" onclick="location.href='#accbienes'">Continuar con la Carga
                        de Acciòn Centralizada Bienes</button>
                    <button
