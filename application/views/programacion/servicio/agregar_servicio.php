                    ...
                    <form id="reg_servicio" method="POST" class="form-horizontal">
                        <div class="row">
                            ...
                            <div class="form-group col-12">
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <label>Busqueda para CCNU <i style="color: red;"
                                        ...
                                        <input title="Debe ingresar una palabra para realizar la busqueda" type="text"
                                            class="form-control" name="ccnu" id="ccnu"
                                            onKeyUp="this.value=this.value.toUpperCase();" onblur="buscar_ccnnu();">
                                    </div>
                                    <div class="col-8">
                                        <label>CCNU</label>
                                        <select name="id_ccnu" id="id_ccnu"
                            ...
                            <div class="col-12">
                                <div class="table-responsive mt-4">
                                    ...
                                    <h5 class="text-center"><b style="color:red;">NOTA:</b> La tabla debe tener al menos
                                        un requerimiento agregado, para proceder con la solicitud.</h5>
                            ...
                            <div class="col-12 row text-center mt-3">
                                <div class="col-6">
                                    <button
                                        ...
                                        type="button" id="btn_guar_1" onclick="reg_servicio();"
                                        readonly>Guardar</button>
                                </div>
                                <div class="col-6">
                                    <a class="btn btn-circle waves-effect btn-lg waves-circle waves-float btn-primary"
                                        href="javascript:history.back()"> Volver</a>
