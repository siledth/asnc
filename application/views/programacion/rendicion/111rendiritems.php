                        ...
                        <table id="data-table-default" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX" style="text-align:center">
                                    ...
                                    <td style="color:red;"><?=$data['desc_accion_centralizada']?> </td>
                        ...
                        <div class="card card-outline-danger">
                            ...
                            <div class="row ">
                                ...
                                <div class="form-group col-2">
                                    ...
                                    <input id="monto3_rendi" name="monto3_rendi" onkeyup="verif();" class="form-control"
                                        readonly>
                                </div>
                            </div>
                        ...
                        <div class="card card-outline-green">
                            ...
                            <div class="row ">
                                ...
                                <div class="form-group col-2">
                                    ...
                                    <input id="total_pago_rendi" name="total_pago_rendi" class="form-control">
                                </div>
                                <div class="form-group col-2">
                                    <label>Paridad US$ <b style="color:red">*</b> <br><br></label>
                    ...
                    <div class="row">
                        ...
                        <div class="card card-outline-danger">
                            ...
                            <div class="row ">
                                ...
                                <div class="form-group col-4">
                                    <label> PROCEDIMIENTO DE CONTRATACIÓN </label>
                                    <select class="form-control" name="modalida_rendi3" id="modalida_rendi3">
                                        <option value="0">Seleccione</option>
                                    </select>
                                </div>
                                <div class="form-group col-12">
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            <input title="Debe ingresar una palabra para realizar la busqueda"
                                                type="text" class="form-control"
                                                onKeyUp="this.value=this.value.toUpperCase();" name="rif_nombre3"
                                                id="rif_nombre3" onblur="buscar_rif3();"
                                                oninput="this.value = this.value.replace(/[^a-zA-Z0-9]/,'')">
                                        </div>
                                        <div class="col-8">
                                            <select
                                                title="Depende de la palabra ingresada en el campo anterior, se listaran las opciones."
                                                class="form-control" name="sel_rif_nombre3" id="sel_rif_nombre3">
                                                <option value="0">Seleccione</option>
                                            </select>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <select class="form-control" name="llenar_trimestre5" id="llenar_trimestre5"
                                onblur="calculos_rendi_bienessacc();">
                                <option value="0">Seleccione</option>
                            </select>
                        </div>
                        <div class="form-group col-2">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            <input title="Debe ingresar una palabra para realizar la busqueda"
                                                type="text" class="form-control"
                                                onKeyUp="this.value=this.value.toUpperCase();" name="rif_5" id="rif_5"
                                                onblur="buscar_rif5();"
                                                oninput="this.value = this.value.replace(/[^a-zA-Z0-9]/,'')">
                                        </div>
                                        <div class="col-8">
                                            <select
                                                title="Depende de la palabra ingresada en el campo anterior, se listaran las opciones."
                                                class="form-control" name="sel_rif_nombre5" id="sel_rif_nombre5">
                                                <option value="0">Seleccione</option>
                                            </select>
                                        </div>
                                    </div>
                        ...
                        <div class="card card-outline-green">
                            ...
                            <div class="row ">
                                ...
                                <div class="form-group col-2">
                                    <label>TOTAL PAGO <b style="color:red">*</b><br><br></label>
                                    <input id="total_pago_rendi5" name="total_pago_rendi5" class="form-control">
                                </div>
                                <div class="form-group col-2">
                                    <label>Paridad US$ <b style="color:red">*</b> <br><br></label>
                        ...
                        <div class="card card-outline-black">
                            ...
                            <div class="row ">
                                ...
                                <div class="form-group col-2">
                                    <label>III Trimestre</label>
                                    <input type="text" class="form-control" onkeypress="return valideKey(event);"
                                        name="tercero_b7" id="segundo_b7" readonly>
                                </div>
                                <div class="form-group col-2">
                                    <label>IV Trimestre</label>
                                    <input type="text" class="form-control" onkeypress="return valideKey(event);"
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-8">
                                            <select
                                                title="Depende de la palabra ingresada en el campo anterior, se listaran las opciones."
                                                class="form-control" name="sel_rif_nombre7" id="sel_rif_nombre7">
                                                <option value="0">Seleccione</option>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="row ">
                                ...
                                <div class="form-group col-2">
                                    ...
                                    <input type="text" class="form-control" onkeypress="return valideKey(event);"
                                        ...
                                        id="monto_factura_rend7">
                                </div>
                                <div class="form-group col-2">
                                    <label>TOTAL PAGO <b style="color:red">*</b><br><br></label>
                                    <input id="total_pago_rendi7" name="total_pago_rendi7" class="form-control">
                                </div>
                                <div class="form-group col-2">
                                    <label>Paridad US$ <b style="color:red">*</b> <br><br></label>
