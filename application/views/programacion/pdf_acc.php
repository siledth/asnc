                ...
                <div class="panel-body">
                    <div class="row">
                            ...
                            <div class="card card-outline-danger text-center bg-white">
                                <div class="card-block">
                                    <blockquote class="card-blockquote" style="margin-bottom: -19px;">
                                        <p class="f-s-18 text-inverse f-w-600">Nombre Órgano / Ente: <?=$des_unidad?>.
                                        </p>
                        ...
                        <div class="col-9 mt-2 form-group">
                            ...
                            <input value="<?=$inf_1['desc_accion_centralizada']?>" type="text" class="form-control"
                                disabled>
                        </div>
                        <div class="form-group mt-2  col-3">
                            <label>Objeto de Contratación</label>
                            <input value="<?=$inf_1['desc_objeto_contrata']?>" type="text" class="form-control"
                                disabled>
                        </div>
