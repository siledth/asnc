            ...
            <div class="panel panel-inverse">
                ...
                <div class="row">
                    ...
                    <div class="col-6 text-center mt-3">
                        <h3 class="text-center">Rendiciones Notificadas Tercer Trimestre</h3>
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX" style="text-align:center">
                                    ...
                                    <td class="center">
                                        ...
                                        <a href="<?php echo base_url();?>index.php/Programacion/ver_rendicion_realizadas3?id=<?php echo $lista['id_programacion'];?>"
                                            class="button">
