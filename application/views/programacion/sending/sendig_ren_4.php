            ...
            <div class="panel panel-inverse">
                ...
                <div class="row">
                    ...
                    <div class="col-6 text-center mt-3">
                        <h3 class="text-center">Rendiciones Notificadas Cuarto Trimestre</h3>
                    ...
                    <thead style="background:#01cdb2">
                            ...
                            <tbody>
                                ...
                                <td><?=$lista['id_ainf_enviada']?> </td>
                                    ...
                                    <a href="<?php echo base_url();?>index.php/Programacion/ver_rendicion_realizadas4?id=<?php echo $lista['id_programacion'];?>"
                                     class="button">
