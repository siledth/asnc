...
<div id="content" class="content">
    <h2>Reprogramación "Proyecto-Servicio"</h2>
    <div class="row">
                ...
                <form class="form-horizontal" id="guardar_tcu" data-parsley-validate="true" method="POST"
                    ...
                    <div class="panel-body">
                        ...
                        <input type="hidden" id="id_programacion3" name="id_programacion3"
                            ...
                            <div class="form-group col-6">
                                <label style="color:red;">Ingrese Rango de Fecha Estimado para Ejecución del Servicio (Obligatorio).leer <b style="color:red">*</b></label><i style="color: red;" title="Seleccione la Fecha estimada de ejecución de la obra."
                    ...
                    <div class="form-group col 12 text-center">
                        <button type="button" onclick="Guardar_repro_servicio_proyectos();" id="guardar" name="guardar"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Reprogramar Servicio-proyecto</h4>
                </div>
