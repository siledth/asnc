                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Especificación <b style="color:red">*</b> <i style="color: red;"
                                        title="Ingrese Especificación de la obra" class="fas fa-question-circle"></i>
                                </label>
                            ...
                            <div class="form-group col-2">
                                ...
                                <input type="date" id="fecha_hasta" name="fecha_hasta" placeholder="fecha" required
                                    class="form-control " />
                            ...
                            <div class="col-12">
                                <div class="card card-outline-danger">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="form-group col-4">
                                            <label>Porcentaje a Distribuir <b style="color:red">*</b> <i
                                                    style="color: red;"
                        ...
                        <div class="col-12">
                            <div class="card card-outline-danger">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="form-group col-4">
                                        <label>Porcentaje a Distribuir <b style="color:red">*leer</b> <i
                                                style="color: red;"
                                                title="Restara con los valores ingresados en los campos de trimestres, debe dar un Valor de Cero(0)."
                                                class="fas fa-question-circle"></i></label>
