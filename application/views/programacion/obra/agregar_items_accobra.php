...
<div id="content" class="content">
    <h2>Continuar la carga de la programación Obras-acc</h2>
    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-3">
                                ...
                                <select id="id_alcance_obra" name="id_alcance_obra" class="form-control">
                                    ...
                                    <option value="<?=$data['id_alcance_obra']?>"><?=$data['descripcion_alcance_obra']?>
                                    </option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group col-6">
                                <label>Especificación <b style="color:red">*</b> <i style="color: red;"
                                        title="Ingrese Especificación de la obra."
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Editar Obra-ACC</h4>
                </div>
