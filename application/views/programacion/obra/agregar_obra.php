            ...
            <div class="panel panel-inverse">
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-4">
                            <button
                                onclick="location.href='<?php echo base_url()?>index.php/Programacion/agregar_bien?id=<?php echo $id_programacion;?>'"
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 mt-3 form-group" id="acc_s" style="display:none;">
                                ...
                                <select style="width: 100%;" name="id_accion_centralizada" id="id_accion_centralizada"
                                    ...
                                    <option value="<?=$data['id_accion_centralizada']?>">
                                        <?=$data['desc_accion_centralizada']?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group mt-3 col-3">
                                ...
                                <input type="text" class="form-control" id="id_obj_comercial" name="id_obj_comercial"
                                    value="Obras" readonly>
                            </div>
                            ...
                            <div class="form-group col-12">
                                ...
                                <select id="par_presupuestaria" required name="par_presupuestaria"
                                    class="default-select2 form-control">
                                    <option value="0">Seleccione</option>
                            ...
                            <div class="form-group col-3">
                                ...
                                <input id="porcentaje" onblur="porc();" id="porcentaje" type="text"
                                    class="form-control">
                            </div>
                            <div class="col-12">
                                <h5 class="text-center"><b style="color:red;">NOTA:</b> Debe llenar todos lo items para
                                    llenar la tabla. <br>
                                    <b>Recuerde que la suma del procentaje de cada fuente de Financiamiento debe dar un
                                        total de 100</b>
                                </h5>
                            </div>
                            <div class="col-5"></div>
                            ...
                            <div class="form-group col-4">
                                ...
                                <select id="id_tip_obra" name="id_tip_obra" class="form-control">
                                    ...
                                    <option value="<?=$data['id_tip_obra']?>/<?=$data['descripcion_tip_obr']?>">
                            ...
                            <div class="form-group col-4">
                                ...
                                <select id="id_alcance_obra" name="id_alcance_obra" class="form-control">
                                    ...
                                    <option
                                        value="<?=$data['id_alcance_obra']?>/<?=$data['descripcion_alcance_obra']?>">
                            ...
                            <div class="form-group col-4">
                                ...
                                <select id="id_obj_obra" name="id_obj_obra" class="form-control">
                                    ...
                                    <option value="<?=$data['id_obj_obra']?>/<?=$data['descripcion_obj_obra']?>">
                                ...
                                <div class="row mt-2">
                                    <div class="form-group col-2">
                                        ...
                                        <input id="I" name="I" type="text" onblur="calculo();" value="0"
                                            class="form-control" onkeypress="return valideKey(event);" disabled>
                                    </div>
                                    <div class="form-group col-2">
                                    ...
                                    <div class="form-group col-4">
                                        ...
                                        <input id="cant_total_distribuir" value="100" onblur="calculo();"
                                            name="cant_total_distribuir" type="number" class="form-control" disabled>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12 text-center row mt-3">
                            <div class="col-6">
                                <button class="btn btn-circle waves-effect btn-lg waves-circle waves-float btn-success"
                                    type="button" name="button" id="btn_guar" onclick="guardar_obra();"
...
<script src="<?=base_url()?>/js/obra/calculo_obra.js"></script>
