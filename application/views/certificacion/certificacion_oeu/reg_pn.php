        ...
        <div class="panel panel-inverse">
            ...
            <div class="panel-body" id="existe">
                ...
                <form class="form-horizontal" id="reg_bien" name="reg_bien" data-parsley-validate="true" method="POST"
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            <h4 class="panel-title"><b>INFORMACIÓN </b></h4>
                        </div>
                        <div class="panel-body" id="existe">
                            <div class="row">
                                                ...
                                                <?php if (isset(($exonerado))) { ?>
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-3">
                                                            ...
                                                            <input id="n_ref" name="n_ref" type="hidden" Value="Exonerado"
                                                                class="form-control">
                                                        </div>
                                                        <div class="form-group col-4">
                        ...
                        <div class="row text-center mt-3">
                            <div class="col-6">
                                <button class="btn btn-circle waves-effect btn-lg waves-circle waves-float btn-success"
                                    type="button" onclick="guardar_registro2();" id="btn_guar_2" name="button"
                                    disabled>Guardar
