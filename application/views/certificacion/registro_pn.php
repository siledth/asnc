...
<div id="content" class="content">
    <h2>REGISTRO PARA CERTIFICACIÓN DE PERSONA NATURAL DE CARÁCTER PRIVADO</h2>
    <div class="row">
        <div class="col-lg-12">
        ...
        <div class="col-lg-12" style="display: none" id="items">
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    <h4 class="panel-title text-center"><b>FICHA TÉCNICA DE CERTIFICACIÓN PARA PERSONA NATURAL DE
                            CARÁCTER PRIVADO</b></h4>
                </div>
                            ...
                            <div class="tab-pane fade" id="declara">
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-3">
                                            <label>Acepto <b title="Campo Obligatorio" style="color:red">*</b></label>
                ...
                <div class="row text-center mt-3">
                    <div class="col-6">
                        <button class="btn btn-circle waves-effect btn-lg waves-circle waves-float btn-success"
                            type="button" onclick="guardar_registro();" id="btn_guar_2" name="button" disabled>Guardar
