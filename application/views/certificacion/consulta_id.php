                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-12 mt-0 text-center">
                            ...
                            <h4 style="color:red;">FICHA TÉCNICA DE CERTIFICACIÓN
                                <br>
                            </h4>
                            <h6 style="color:red;">INFORMACIÓN</h6>
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="guardar_proc_pag" name="guardar_proc_pag" data-parsley-validate="true"
                    ...
                    <div class="row">
                        ...
                        <input class="form-control" type="hidden" name="users" id="users" value="<?= $users ?>"
                            readonly>
