        ...
        <div class="row">
            <div class="panel panel-inverse">
                <div class="panel-body">
                    ...
                    <form id="reg_bien" action="<?=base_url()?>index.php/Certificacion/renovar_certificacion"
                        ...
                        <div class="row">
                                ...
                                <div class="card card-outline-danger text-center bg-white">
                                    <div class="card-block">
                                        <blockquote class="card-blockquote" style="margin-bottom: -19px;">
                                            ...
                                            <h3 style="color:red;">Renovación de Certificación PJ</h3>
                                        </blockquote>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-3">
                                ...
                                <input id="fecha_solic" name="fecha_solic"
                                    value="<?=date("d/m/Y", strtotime($time));?>" type="text"
                                    class="form-control" readonly>
