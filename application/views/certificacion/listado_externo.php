                                    ...
                                    <td class="center">
                                        <a href="<?php echo base_url();?>index.php/Certificacion/ver_certifi?id=<?php echo $datos['rif_cont'];?>"
                                            ...
                                            <?php if ( $datos['status'] == 3 ) : ?>
                                                <a onclick="modal(<?php echo $datos['id']?>);" data-toggle="modal" data-target="#exampleModal" style="color: white">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="guardar_pago_2_" name="guardar_pago_2_" data-parsley-validate="true" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="form-group col-3">
                            ...
                            <input class="form-control" type="text" id="pago2" name="pago2" onkeypress="return valideKey(event);">
                        </div>
                        <div class="col-4">
                            <label>Banco Emisor</label>
                            <select style="width: 100%;" name="banco_e2" id="banco_e2"
                                                            class="form-control ">
                        ...
                        <div class="form-group col-3">
                            ...
                            <input class="form-control" type="text" id="banco_rec_2" name="banco_rec_2" value="Banco de Venezuela" readonly>
                        </div>
                        <div class="col-4">
