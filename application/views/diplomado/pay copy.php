...
<head>
    ...
    <script type="text/javascript">
        ...
        var recaptchaWidgetIdPay; // Variable global para almacenar el ID del widget de reCAPTCHA de Pago

        // Función de callback de reCAPTCHA para el formulario de Pago - Se ejecuta cuando la API de reCAPTCHA está lista
        var onloadCallbackPay = function() {
            if (document.getElementById('recaptcha-widget-pay')) {
                ...
                console.error("Error: Elemento 'recaptcha-widget-pay' no encontrado en el DOM.");
            }
        };

        // Función para reiniciar el reCAPTCHA del formulario de Pago
        function resetRecaptchaPay() {
            if (typeof grecaptcha !== 'undefined' && typeof grecaptcha.reset === 'function' && recaptchaWidgetIdPay !==
                ...
                console.warn("No se pudo reiniciar reCAPTCHA Pago: grecaptcha no definido o widgetId inválido.");
            }
        }
    </script>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input type="text" id="telefonoPagador" name="telefonoPagador"
                                            class="form-control" placeholder="Ej: 04121234567" maxlength="12" required
                                            data-parsley-trigger="change" value="04148400858">
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label for="telefonoDestino">Teléfono Destino</label>
                                        <input type="text" id="telefonoDestino" name="telefonoDestino"
                                            class="form-control" placeholder="Ej: 02121234567" maxlength="12" required
                                            data-parsley-trigger="change" value="04126010945">
                                    </div>
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="text" id="referencia" name="referencia" class="form-control"
                                            ...
                                            data-parsley-trigger="change" value="000244014840">
                                    </div>
                                    ...
                                    <div class="form-section mt-4 p-3 border rounded">
                                        <h5><i class="fas fa-file-invoice mr-2"></i>Declaración de Pago</h5>
                                        <div class="form-group form-check">
                                            ...
                                            <div class="invalid-feedback" id="declaracionPago-feedback"
                                                style="display: none;">
                                    ...
                                    <div class="form-section mt-4 p-3 border rounded">
                                        <h5><i class="fas fa-robot mr-2"></i>Verificación de Seguridad</h5>
                                        <div class="form-group text-center">
                                            <div id="recaptcha-widget-pay"></div>
