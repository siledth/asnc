                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-inverse">
                            <div class="panel-heading">
                                <h4 class="panel-title">Inscripciones Persona Jurídica</h4>
                            </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="panel panel-default">
                                            <div class="panel-body">
                                                ...
                                                <ul class="list-group">
                                                    <?php foreach ($inscripcion_juridica_stats['by_diplomado_juridica'] as $diplomado_jur_stat): ?>
                                                        <li
                                                        ...
                                                        <ul
                                                            style="list-style: none; padding-left: 10px; font-size: 1.5em; margin-bottom: 10px;">
                                                            <li class="d-flex align-items-center">
                                                                Preinscrito
                                                                <span class="badge badge-info badge-pill ml-auto">
                                                                    <?= $diplomado_jur_stat['total_preinscrito'] ?>
                                                                </span>
                                                            </li>
                                                            <li class="d-flex align-items-center">
                                                                Aceptado / Espera Pago
                                                                <span class="badge badge-warning badge-pill ml-auto">
                                                                    <?= $diplomado_jur_stat['total_aceptado_espera_pago'] ?>
                                                                </span>
                                                            </li>
                                                            <li class="d-flex align-items-center">
                                                                Aprobado / Exonerado
                                                                <span class="badge badge-success badge-pill ml-auto">
                                                                    <?= $diplomado_jur_stat['total_exonerado'] ?>
                                                                </span>
                                                            </li>
                                                            <li class="d-flex align-items-center">
                                                                Aprobado / Próxima Corte
                                                                <span class="badge badge-danger badge-pill ml-auto">
                                                                    <?= $diplomado_jur_stat['total_aprobado_proxima_corte'] ?>
                                                                </span>
                                                            </li>
                                                        </ul>
                                                    <?php endforeach; ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="d-flex flex-column align-items-center justify-content-around h-50">
                                            <div class="circle-stat bg-warning text-white">
                                                <span
                                                    class="stat-value"><?= $inscripcion_juridica_stats['total_general_juridica'] ?? 0 ?></span>
                                                <span class="stat-label">TOTAL INSCRITOS JURÍDICOS</span>
                                            </div>

                                            <div class="circle-stat bg-info text-white">
                                                <span class="stat-value">
                                                    <?php
                                                    $total_aprobados_jur = 0;
                                                    foreach ($inscripcion_juridica_stats['by_diplomado_juridica'] as $d_jur_stat) {
                                                        // Sumar estatus 2 y estatus 5 para aprobados jurídicos
                                                        $total_aprobados_jur += $d_jur_stat['total_aceptado_espera_pago'] + $d_jur_stat['total_exonerado'];
                                                    }
                                                    echo $total_aprobados_jur;
                                                    ?>
                                                </span>
                                                <span class="stat-label">TOTAL APROBADOS JURÍDICOS</span>
                                            </div>

                                            <div class="circle-stat bg-danger text-white">
                                                <span class="stat-value">
                                                    <?php
                                                    $total_preinscritos_jur_global = 0;
                                                    foreach ($inscripcion_juridica_stats['global_by_estatus_juridica'] as $global_jur_stat) {
                                                        if ($global_jur_stat['estatus'] == 1) {
                                                            $total_preinscritos_jur_global = $global_jur_stat['total_global_estatus'];
                                                            break;
                                                        }
                                                    }
                                                    echo $total_preinscritos_jur_global;
                                                    ?>
                                                </span>
                                                <span class="stat-label">PREINSCRITOS JURÍDICOS EN ESPERA</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
