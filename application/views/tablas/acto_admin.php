...
<div id="content" class="content">
    <h2>Registro de Acto Administrativo</h2>
    <div class="row">
        <div class="col-lg-12">
				...
				<form class="form-horizontal" id="guardar_ba" data-parsley-validate="true" method="POST" enctype="multipart/form-data">
					<div class="panel-body">
						...
						<div class="form-group col-6">
							<label>Descripción acto administrativo <b title="Campo Obligatorio" style="color:red">*</b></label>
					...
					<div class="form-group col 12 text-center">
                        <button type="button" onclick="guardar_acto();" id="guardar" name="guardar" class="btn btn-primary mb-3">Guardar</button>
                    </div>
				</from>
            </div>
				...
				<div class="table-responsive">
					<table  id="data-table-default" data-order='[[ 0, "asc" ]]'
						...
						<tbody>
                            ...
                            <td ><?=$data['id_acto_admin']?> </td>

                                <td><?=$data['desc_acto_admin']?> </td>

                                <td class="center">
									<a class="button">
                                        <i title="Editar" onclick="modal_veracto(<?php echo $data['id_acto_admin']?>);" data-toggle="modal" data-target="#exampleModal" class="fas fa-lg fa-fw fa-edit" style="color:green"></i>
                                    <a/>
									<!-- <a class="button"><i onclick="eliminar_b(<?php echo $data['id_acto_admin']?>);" class="fas fa-lg fa-fw fa-trash-alt" style="color:red"></i><a/> -->
                                </td>
                            </tr>
                            <?php endforeach;?>
                        </tbody>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" onclick="editar_acto();" class="btn btn-primary">Guardar</button>
            </div>
        </div>
    </div>
</div>
