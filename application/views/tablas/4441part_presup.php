				...
				<form class="form-horizontal" id="guardar_ba" data-parsley-validate="true" method="POST" enctype="multipart/form-data">
					<div class="panel-body">
						...
						<div class="form-group col-6">
							<label>Codigo de la Partida Presupuestaria <b title="Campo Obligatorio" style="color:red">*</b></label>
							<input class="form-control" onkeypress="may(this);"  type="text" name="codigo_b" id="codigo_b" placeholder="XXXX">
							</select>
						</div>
						<div class="form-group col-6">
							<label>Descripción de la Partida Presupuestaria <b title="Campo Obligatorio" style="color:red">*</b></label>
							<input class="form-control" onkeypress="may(this);" type="text" name="nombre_b" id="nombre_b" placeholder="Nombre de la partida">
						</div>
					...
					<table  id="data-table-default" data-order='[[ 0, "desc" ]]'
						...
						<tbody>
                            ...
                            <td style="color:white;"><?=$data['id_partida_presupuestaria']?> </td>
                                ...
                                <td class="center">
									<a class="button">
                                        <i title="Editar" onclick="modal_ver(<?php echo $data['id_partida_presupuestaria']?>);" data-toggle="modal" data-target="#exampleModal" class="fas fa-lg fa-fw fa-edit" style="color:green"></i>
                                    <a/>
