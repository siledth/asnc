                        ...
                        <?php if ($rif_organoente == "G200024518") : ?>
                            ...
                            <tr class="odd gradeX" style="text-align:center">
                                ...
                                <td class="center">
                                    ...
                                    <a/>
                                    <a class="button">
                                            <i title="Notifiaciòn" onclick="modal(<?php echo $data['id']?>);" data-toggle="modal" data-target="#exampleModal" class="fas fas fa-lg fa-fw fa-align-justify" style="color: red;"></i>
                                        <a/>
                                </td>
                            </tr>
                            <?php endforeach;?>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                            ...
                            <div class="form-group col-6">
								...
								<input type="text" class="form-control" id="datepicker-default" name="fecha_not" placeholder="Seleccionar Fecha" onchange="validar_fecha();"/>
                            </div>
                            <div class="form-group col-6">
