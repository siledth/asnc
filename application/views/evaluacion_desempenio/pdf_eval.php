    ...
    <div class="row">
        ...
        <div class="col-3 text-center">
            ...
            <button class="btn btn-circle waves-effect btn-lg waves-circle waves-float btn-primary"
                onclick="printContents('imp1');">Imprimir</button>
        </div>
        <div class="col-lg-12" id="imp1">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading" style="padding: 2px 15px;">
                    <h2 style="font-size: 16px;" class="panel-title text-center"><b>Datos del Contratista Adjudicado</b>
                    </h2>
                </div>
                <div class="panel-body" style="padding: 0px;">
                    <div class="row" style="margin-bottom: -23px;">
                ...
                <div class="panel-heading" style="padding: 2px 15px;">
                    <h5 style="font-size: 16px;" class="panel-title text-center"><b>Modalidad de la Contratación</b>
                    </h5>
                </div>
                <div class="panel-body" style="padding: 0px;">
                    <div class="row" style="margin-bottom: -23px;">
                ...
                <div class="panel-heading" style="padding: 2px 15px;">
                    <h5 style="font-size: 16px;" class="panel-title text-center"><b>Tabla de Evaluación del
                            Contratista</b></h5>
                </div>
                            ...
                            <tbody>
                                <tr style="font-size: 10px;">
                                    ...
                                    <td>Mide el cumplimiento de los parámetros técnicos y de calidad exigidos:
                                        ...
                                        confiable de equipos, instrumentos e infraestructura adecuados, procura (compra,
                                        manejo y almacenaje), respuesta eficiente a reclamos técnicos/calidad,
                                        organización e implantación de mejoras</td>
                                    <td>25</td>
                                    <td>
                                ...
                                <tr style="font-size: 10px;">
                                    ...
                                    <td>Cumplimiento de leyes, decretos y clausulas relativos al contrato, respuestas a
                                        demandas o reclamos de proveedores/subcontratistas, cumplimiento y respuesta de
                                        requisitos como solvencia laboral, administración de vacaciones, reclamos
                                        laborales, paros, demñas obligraciones legales y contractuales</td>
                                    <td>25</td>
                                    <td>
                                ...
                                <tr style="font-size: 10px;">
                                    ...
                                    <td>Cumplimiento de practicas de trabajo seguro, programas de inspección SHA,
                                        herramientas y equipos, condiciones del area de trabajo adecuadas,
                                        adiestramiento y motivación al personal, SHA de contratistas, respuesta y
                                        control de emergencias entre otras, aplicacion de las normativas técnicas.</td>
                                    <td>25</td>
                                    <td>
                                ...
                                <tr style="font-size: 10px;">
                                    ...
                                    <td>Corresponde al periodo establecido en el contrato para la ejecución de la obra,
                                        prestación del servicio o suministro de bienes.</td>
                                    <td>25</td>
                                    <td>
