<style>
    /* 1. REGLA MÁS FUERTE PARA EL CONTENEDOR PRINCIPAL DEL CONTENIDO */
    /* Apuntamos al modal-content que es la caja blanca del modal. */
    #exampleModal_ver .modal-content {
        background-color: #fff !important;
        /* Asegura que no haya bordes de tema */
        border: 1px solid rgba(0, 0, 0, 0.2);
    }

    /* 2. REGLA AGRESIVA PARA EL CUERPO DEL MODAL */
    /* Aseguramos que el fondo del cuerpo sea blanco, anulando cualquier herencia. */
    #exampleModal_ver .modal-body {
        background-color: #fff !important;
    }

    /* 3. Estilo para la caja de descripción */
    #descp_anul_ver {
        background-color: #fff !important;
    ...
    /* 4. Estilos de layout para las etiquetas */
    .modal-body .row .col-4 span,
    .modal-body .row .col-8 span,
...
<!-- <div class="modal fade" id="exampleModal_ver" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="resgistrar_anulacion_ver_form" data-parsley-validate="true"
                    method="POST" enctype="multipart/form-data">
                    <div class="row">
                        <div class="form-group col-2">
                            <label>ID de Evaluación</label>
                            <div class="form-control-plaintext text-center" id="id_ver"></div>
                        </div>
                        <div class="col-10"></div>
                        <div class="form-group col-4">
                            <label>Nro. de Oficio de la Solicitud</label>
                            <div class="form-control-plaintext" id="nro_oficicio_ver"></div>
                        </div>
                        <div class="form-group col-4">
                            <label>Fecha de Notificación</label>
                            <div class="form-control-plaintext" id="fec_solicitud_ver"></div>
                        </div>
                        <div class="form-group col-4">
                            <label>Nro. del Expediente</label>
                            <div class="form-control-plaintext" id="nro_expediente_ver"></div>
                        </div>
                        <div class="form-group col-4">
                            <label>Nro. Gaceta, Resolución o Providencia</label>
                            <div class="form-control-plaintext" id="nro_gacet_resol_ver"></div>
                        </div>
                        <div class="form-group col-4">
                            <label>Cédula del Sol.</label>
                            <div class="form-control-plaintext" id="cedula_solc_ver"></div>
                        </div>
                        <div class="form-group col-4">
                            <label>Télefono del Solicitante</label>
                            <div class="form-control-plaintext" id="telf_solc_ver"></div>
                        </div>
                        <div class="form-group col-6">
                            <label>Nombre y Apellido del Solicitante</label>
                            <div class="form-control-plaintext" id="nom_ape_solc_ver"></div>
                        </div>
                        <div class="form-group col-6">
                            <label>Cargo</label>
                            <div class="form-control-plaintext" id="cargo_ver"></div>
                        </div>
                        <div class="form-group col-12">
                            <label>Breve descripción de la Solicitud</label>
                            <div class="form-control-plaintext" id="descp_anul_ver" style="white-space: pre-wrap;">
                            </div>
                        </div>
                    </div>
                </form>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-12">
                        <h6 class="text-info font-weight-bold border-bottom pb-1">DATOS DE LA SOLICITUD</h6>
                    </div>

                    <div class="col-4 mb-2">
                        <span class="d-block text-muted small">ID Evaluación:</span>
                        <strong id="id_ver" class="text-dark"></strong>
                    </div>
                    <div class="col-4 mb-2">
                        <span class="d-block text-muted small">Nro. Oficio:</span>
                        <strong id="nro_oficicio_ver" class="text-dark"></strong>
                    </div>
                    <div class="col-4 mb-2">
                        <span class="d-block text-muted small">Fecha Notif.:</span>
                        <strong id="fec_solicitud_ver" class="text-dark"></strong>
                    </div>

                    <div class="col-4 mb-2">
                        <span class="d-block text-muted small">Nro. Expediente:</span>
                        <strong id="nro_expediente_ver" class="text-dark"></strong>
                    </div>
                    <div class="col-8 mb-2">
                        <span class="d-block text-muted small">Nro. Gaceta/Resolución:</span>
                        <strong id="nro_gacet_resol_ver" class="text-dark"></strong>
                    </div>

                    <div class="col-12">
                        <h6 class="text-info font-weight-bold border-bottom pb-1 mt-3">DATOS DEL SOLICITANTE</h6>
                    </div>

                    <div class="col-4 mb-2">
                        <span class="d-block text-muted small">Cédula del Sol.:</span>
                        <strong id="cedula_solc_ver" class="text-dark"></strong>
                    </div>
                    <div class="col-8 mb-2">
                        <span class="d-block text-muted small">Nombre y Apellido:</span>
                        <strong id="nom_ape_solc_ver" class="text-dark"></strong>
                    </div>

                    <div class="col-4 mb-2">
                        <span class="d-block text-muted small">Teléfono:</span>
                        <strong id="telf_solc_ver" class="text-dark"></strong>
                    </div>
                    <div class="col-8 mb-2">
                        <span class="d-block text-muted small">Cargo:</span>
                        <strong id="cargo_ver" class="text-dark"></strong>
                    </div>

                    <div class="col-12">
                        <h6 class="text-info font-weight-bold border-bottom pb-1 mt-3">DESCRIPCIÓN</h6>
                    </div>

                    <div class="col-12 mb-2">
                        <span class="d-block text-muted small">Breve descripción de la Solicitud:</span>
                        <div id="descp_anul_ver" class="alert alert-secondary p-2 mt-1" style="white-space: pre-wrap;">
                        </div>
                    </div>
                </div>
            </div>
