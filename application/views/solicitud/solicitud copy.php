...
<body class="hold-transition1 login-page fondo">
    <!-- <div class="login-box r"> -->
    <div class="card r">
        <div class="card-body r login-card-body">
            <div class="col-12 ml-1">
                <img style="width: 100%" height="10%" src=" <?= base_url() ?>Plantilla/img/loij.png" alt="Card image">
                    ...
                    <div class="card-block">
                        <blockquote class="card-blockquote" style="margin-bottom: -15px;">
                            <div class="panel-body">
                                <form class="form-horizontal" id="sav_ext" name="sav_ext" data-parsley-validate="true"
                                    method="POST" enctype="multipart/form-data">

                                    <div class="col-12">
                                        <h5 class="text-center"> <b>PLANILLA DE CREACIÓN O ACTUALIZACIÓN DE
                                                DATOS
                                            </b></h5>
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="form-group col-12">
                                                <label><i style="color: red;" title="Ingrese el Rif, para continuar."
                                            ...
                                            <div class="form-group col-12" id='no_existe' style="display: none;">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-8">
                                                        <label>Nombre del Órgano / Ente: <b style="color:red">*</b>
                                                        </label>
                                            ...
                                            <div class="col-4">
                                                <label>RIF Órgano/Ente de Adscripción: <b , style="color:red">*</b>
                                                </label>
                                            ...
                                            <div class="col-8">
                                                <label>Nombre Órgano/Ente de Adscripción: <b style="color:red">*</b>
                                                </label>
                                            ...
                                            <div class="form-group col-4">
                                                ...
                                                <input type="text" id="cod_onapre" name="cod_onapre"
                                                    class="form-control" placeholder="Codigo Onapre" maxlength="20">
                                            ...
                                            <div class="form-group col-12">
                                                <label>DATOS DEL USUARIO O USUARIA DE LA CLAVE<b
                                                        title="Campo Obligatorio" style="color:red">*</b></label><br>
                                            </div>
                                            <div class="form-group col-3">
                                            ...
                                            <div class="form-group col-2">
                                                <label>Cargo <b title="Campo Obligatorio"
                                                        style="color:red">*</b></label>
                                                <input type="text" id="cargo_f" name="cargo_f" placeholder="Cargo"
                                            ...
                                            <div class="form-group col-2">
                                                ...
                                                <input type="text" id="telefono_f" name="telefono_f"
                                                    placeholder="Teléfono 1" maxlength="20" class="form-control" />

                                            </div>
                                            <div class="form-group col-5">
                                                <label>Correo Electrónico<b title="Campo Obligatorio" style="color:red">
                                                        (Institucional o cifrado
                                                        seguro)
