            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body" style="padding: 1px;">
                    <div class="row ml-1">
                        ...
                        <div class="col-6">
                            <h6><b>Inscripción en el RNC: </b><?= date("d-m-Y", strtotime($rifced['fecinscrnc_at2'])) ?>
                            </h6>
                        </div>
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            <h6><b>Vencimiento en el RNC:</b>
                                <?= date("d-m-Y ", strtotime($rifced['fecvencrnc_at2'])) ?></h6>
                        </div>
                    </div>
                </div>
                <div class="panel-heading" style="padding: 3px 15px;">
                ...
                <div class="panel-heading" style="padding: 3px 15px;">
                    <h5 style="font-size: 16px;" class="panel-title text-center"><b>Información del Registro
                            Mercantil</b></h5>
                </div>
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <h5><b>Duración de la Empresa Actual:
                                </b><?= date("d-m-Y ", strtotime($mercantil['fecduremp_at']))  ?></h5>
                        </div>
                        <div class="col-6">
                            <h5><b>Duración de la Junta Directiva Actual:
                                </b><?= date("d-m-Y ", strtotime($mercantil['fecdurjd_at']))  ?></h5>
                        </div>
                        <div class="col-6">
                            <h5><b>Cierre Fiscal Actual: </b><?= $mercantil['diaciefcal'] ?>/
                                <?= $mercantil['mesciefcal'] ?></h5>
                        </div>
                        <div class="col-6">
                            <h5><b>Capital Social Suscrito Actual:
                                </b>BsF.<?= number_format($mercantil['capsusc'], 2, ".", ",") ?></h5>
                        </div>
                        <div class="col-6"></div>
                        <div class="col-6">
                            <h5><b>Capital Social Pagado Actual:
                                </b>BsF.<?= number_format($mercantil['cappagado'], 2, ".", ",") ?></h5>
                        </div>
                    </div>
                </div>
                <?php    }        else {   ?>
                ...
                <div class="panel-heading" style="padding: 3px 15px;">
                    ...
                    <h5 style="font-size: 16px;" class="panel-title text-center"><b>Accionistas, Miembros de la Junta
                            Directiva y Representantes Legales</b></h5>
                </div>
                ...
                <div class="panel-heading" style="padding: 3px 15px;">
                    <h5 style="font-size: 16px;" class="panel-title text-center"><b>Actividades y Productos del Catálogo
                            de Clasificación de Compras del Estado</b></h5>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="panel-title text-center" style="line-height: 9px;">
                ...
                <div class="panel-heading" style="padding: 3px 15px;">
                    <h5 style="font-size: 16px;" class="panel-title text-center"><b>Relación de Obras y/o Servicios</b>
                    </h5>
                </div>
                ...
                <div class="row ml-1">
                    <div class="col-5">
                        <h6><b>Fecha del Balance:</b>
                            <?= date("d-m-Y ", strtotime($consulta_Balance['fecbalgen_at'])) ?></h6>
                    </div>
                    <div class="col-6">
