                            ...
                            <div class="form-group col-6" id='campos3' style="display: none;">
                                ...
                                <div class="row ">
                                    ...
                                    <input type="hidden" id="rif_organoente" name="rif_organoente"
                                        ...
                                        <input class="form-control" type="date" name="dura_com_desde" id="dura_com_desde">
                                    </div>
                                    <div class="form-group col-4">
                                        <label>Hasta (fecha estimada)</label>
                                        <input class="form-control" type="date" name="dura_com_hasta" id="dura_com_hasta">
                                    </div>
                                ...
                                <tr class="odd gradeX" style="text-align:center">
                                    ...
                                    <?php else: ?>
                                        <a href="<?php echo base_url();?>index.php/Comision_contrata/miemb?id=<?php echo $data['id_comision'];?>"
                                                ...
                                                <a />
                                                <a class="button">
                                        <i title="Editar" onclick="modal_ver(<?php echo $data['id_comision']?>);" data-toggle="modal" 
                                        data-target="#exampleModal3" class="fas fa-2x fa-fw fa-edit" style="color:green"></i>
                                        <a/>
            ...
            <div class="modal-body" data-sortable-id="form-validation-1">
				<form class="form-horizontal" id="editar" data-parsley-validate="true" method="POST" enctype="multipart/form-data">
			    	<div class="row">
                        ...
                        <div class="form-group col-4">
                            <label>Gaceta</label>
                            <input class="form-control" type="text" onkeypress="return valideKey(event);"  name="gace" id="gace">
                        </div>
