    ...
    <div class="row">
            ...
            <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                ...
                <div class="col-12 text-center mt-3 mb-3">
                    <h4 class="text-center mb-3 mt-3">
                        Reporte de Órganos/Entes/Unidades Locales Ejecutoras
                    </h4>
                </div>
        ...
        <div class="col-lg-12" style="display: none" id="items">
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    <h4 class="panel-title text-center"><b>Totales por Mes</b></h4>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-12">
                            <table id="tabla-organos" class="table table-bordered table-hover">
                                <thead style="background:#e4e7e8">
                                    <tr class="text-center">
                                        <th>Mes</th>
                                        <th id="anio_actual"></th>
                                        <th id="anio_anterior"></th>
                                        <th>Diferencia</th>
                                        <th>Variación (%)</th>
                                    </tr>
                                </thead>
...
<script src="<?= base_url() ?>js/reportesG/reporteorganos.js"></script>
