...
<head>
    ...
    <link href="<?= base_url() ?>css/style1.css" rel="stylesheet"  rel="stylesheet"
        type="text/css">
        ...
        <div class="form-information">
          ...
          <a href="https://www.snc.gob.ve/" target="_blank">
            <img class="img" src="<?php echo base_url('baner/logo2.png'); ?>" alt="">
                ...
                <form class="form form-register" form action="<?php echo site_url('login/autenticar'); ?>" method="post"novalidate>
                    <div>
                        <label>
                ...
                <div class="icons">
                   <button type="button"
                                onclick="location.href='<?php echo base_url() ?>index.php/llamadoxterno'"
                                 >Ver Llamados a Concursos</button>
