    ...
    <div class="row">
        <div class="col-lg-12">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="form-group col-4">
                                ...
                                <select id="id_organoads" name="id_organoads" onchange="displaySelectedOption();"
                            ...
                            <div class="form-group col-6">
                                <label>Razon Social del Filiar<b title="Campo Obligatorio"
                            ...
                            <div class="form-group col-4">
                                <label>Siglas <b title="Campo Obligatorio" style="color:red">*</b></label>
            ...
            <div class="form-group col 12 text-center">
                <button type="button" onclick="guardar_filiar();" id="guardar_organo" name="guardar_organo"
...
<script src="<?=base_url()?>/js/organo/filiar.js"></script>
