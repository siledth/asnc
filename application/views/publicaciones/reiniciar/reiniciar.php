...
<div id="content" class="content">
                    ...
                    <form class="form-horizontal" id="guardar_ba" name="guardar_ba" data-parsley-validate="true" method="POST"
                        ...
                        <div class="row">
                                ...
                                <div class="card card-outline-danger text-center bg-white">
                                    <div class="card-block">
                                        <blockquote class="card-blockquote" style="margin-bottom: -19px;">
                                            ...
                                            <H2>Re-Iniciar un LLamado a concurso</H2>
                                        </blockquote>
                                    </div>
                                </div>
                            </div>
                            <?php foreach($causa_reiniciado as $causa_reiniciado):?><?php endforeach;?>
                            <div class="col-12  form-group">
                                <div class="form-group col-10">
                                    <label>Marco Legal</label>
                                    <textarea class="form-control" name="causa_prorroga" id="causa_prorroga" rows="5"
                                        cols="200" readonly>  <?=$causa_reiniciado['descripcion']?></textarea>
                                </div>
                                <hr style="border-top: 1px solid rgba(0, 0, 0, 0.17);">
                            </div>
                            <?php foreach($inf_1 as $inf_1):?>
                            <div class="col-12  form-group">
                                <label>Número Proceso a RE-Iniciar <b style="color:red">*</b></label>
                            ...
                            <div class="col-2  form-group">
                                ...
                                <input id="fecha_entrega_sobre" value="<?=$inf_1['estado_sobre']?>" type="text"
                                    class="form-control" readonly>
                            </div>
                            <div class="col-2  form-group">
                                <label>Municipio <b style="color:red">*</b></label>
                                <input id="fecha_entrega_sobre" value="<?=$inf_1['municipio_sobre']?>" type="text"
                                    class="form-control" readonly>
                            </div>
                            <div class="col-4  form-group">
                                <label>Dirección <b style="color:red">*</b><i style="color: red;"
                                        title="Si desea modificar, ingrese nueva Dirección detallada," class="fas fa-question-circle"></i></label>
                                        <textarea class="form-control" name="direccion_sobre" 
                                        id="direccion_sobre" rows="5" cols="200">  <?=$inf_1['direccion_sobre']?></textarea>
                            </div>
                            <div class="col-4  form-group">
                                <label>Lugar del Acto Público<b style="color:red">*</b><i style="color: red;"
                                        title="Si desea modificar, ingrese nuevo lugar de acto publico" class="fas fa-question-circle"></i></label>
                                        <textarea class="form-control" name="lugar_entrega" 
                                        id="lugar_entrega" rows="5" cols="200">  <?=$inf_1['lugar_entrega']?></textarea>
                            </div>
                            <div class="col-4  form-group">
                            ...
                            <div class="form-group mt-20  col-5">
                                <div class="form-group">
                                    <label for="">Ingrese una Observación sobre el RE-Inicio <b style="color:red">*</b><i style="color: red;"
                        ...
                        <div class="form-group col 12 text-center">
                            <button type="button" onclick="guardar_reinicio();" id="guardar" name="guardar"
    ...
    <script src="<?=base_url()?>/js/publicaciones/reiniciar.js"></script>
