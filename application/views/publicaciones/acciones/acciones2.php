                        ...
                        <table id="data-tablepdf" class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX" style="text-align:center">
                                    ...
                                    <?php else: ?>
                                        <a class="button">
                                        <i title="Editar" onclick="modal_ver(<?php echo $data['id_accion']?>);" data-toggle="modal" data-target="#exampleModal" class="fas fa-lg fa-fw fa-edit" style="color:green"></i>
                                    <a/>
                                    <?php endif; ?>
				...
				<form class="form-horizontal" id="editar" data-parsley-validate="true" method="POST" enctype="multipart/form-data">
			    	<div class="row">
                        ...
                        <div class="form-group col-4">
                            ...
                            <input class="form-control" type="text" onkeypress="return valideKey(event);"  name="cod_banco_edit" id="cod_banco_edit" readonly>
                        </div>
