//llenar modal de servicio reprogramar
function modal(id) {
    var id_p_items = id;
...
/////////////////guardar datos editados del modal
function guardar_tabla_serv_acc(){//////////////////////////////////////////accion central
//     var observaciones2 = $("#observaciones2").val();
    
//     if (document.obser.observaciones2.value.length==0){
//         alert("No Puede dejar el campo Valor observaciones2 vacio, Ingrese un Monto")
//         document.obser.observaciones2.focus()
//         return 0;
//  }
...
//     else{
    ...
    swal.fire({
        title: '¿Seguro desea Reprogramar Servicios? ',
        type: 'warning',
