...
function guardar_b(){
    ...
    swal
        ...
        .then((result) => {
            ...
            if(tel_movil_2 == ''){
                alert("Debe ingresar movil 2 ")
                document.getElementById("tel_movil_2").focus();
                return false;
            }
            if(pag_web == ''){
                alert("Debe ingresar pagina web ")
           ...
           if(email == ''){
            ...
            if(gaceta_oficial == ''){
                alert("Debe ingresar Gaceta Oficial ")
            ...
            if (result.value == true) {
                ...
                var base_url = '/index.php/Configuracion/save_eng_';
...
function guardar_ente_adscrito(){
    var ente = $("#ente").val();
    var cod_onapre = $("#cod_onapre").val();
    var siglas = $("#siglas").val();
    var rif = $("#rif").val();
    ...
    swal
        .fire({
            title: "¿Registrar?",
            text: "¿Esta seguro de registrar Ente  Adscrito?",
            type: "warning",
            showCancelButton: true,
            confirmButtonColor: "#3085d6",
            cancelButtonColor: "#d33",
        ...
        .then((result) => {
           ...
           if(email == ''){
            ...
            if (result.value == true) {
                event.preventDefault();
                var datos = new FormData($("#guardar_ba")[0]);
                var base_url = '/index.php/Configuracion/save_eng_ads';
