...
function consultar_rif(){
    ...
    $("#items").show();
    var base_url = '/index.php/evaluacion_desempenio/llenar_contratistafn';
    //  var base_url = window.location.origin+'/asnc/index.php/evaluacion_desempenio/llenar_contratistafn';
    ...
    $.ajax({
        ...
        success: function(response){
            ...
            if (response.status == 'success') {
                ...
                // Si necesitas consultar los representantes legales,
                ...
                // var base_url2 = window.location.origin+'/asnc/index.php/evaluacion_desempenio/llenar_contratista_rp';
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            rif_cont_nr: data['rifced']
                        },
                        dataType: 'json',
                        success: function(rp_data) {
                            $('#tabla_rep tbody').empty(); // Limpiar la tabla antes de agregar nuevos datos
                            $.each(rp_data, function(index, response) {
                                $('#tabla_rep tbody').append('<tr><td>' + response['cedrif'] + '</td><td>' + response['repr'] + '</td><td>' + response['cargo'] + '</td></tr>');
                            });
                        }
                    });
