$(document).ready(function() {
    ...
    $('#form_reporte_evaluaciones').on('submit', function(e) {
        ...
        var base_url = '/index.php/evaluacion_desempenio/generar_reporte_evaluaciones';
          
        // var base_url = window.location.origin + '/asnc/index.php/evaluacion_desempenio/generar_reporte_evaluaciones';
